 ...
 *
 */
public class NotINClause implements Condition
{
	 ...
	 */
	public NotINClause(String columnName, String values ,String sourceObjectName )
	{
	 ...
	 * It holds comma separated string values for queried column name.
	 */
	public NotINClause(String columnName, String values)
	{
		this.columnName = columnName;
		this.colValueArray = values.split(DAOConstants.DELIMETER);
	 ...
	 */
	public NotINClause(String columnName,
	...
	public String buildSql()throws DAOException
	{
		...
		append(DAOConstants.TRAILING_SPACES).append(DAOConstants.NOT_IN_CONDITION).
