...
public interface JDBCDAO extends DAO
{
    ...
    /**
     * This method will execute the SQL and modifies the database without
     * considering the generated keys.
     *
     * @param sql
     *            sql statement.
     * @return StatementData statement specific data like row count,
     ...
     *             generic DAOException.
     */
    StatementData executeUpdateWithoutGeneratedKeys(String sql) throws DAOException;
     ...
     *            This will holds the object name.
     * @param selectColumnName
     *            An array of field names in select clause.
     * @param queryWhereClause
     *            This will hold the where clause.It holds following:
     *            1.whereColumnName : An array of field names in where clause.
     *            2.whereColumnCondition : The comparison condition for the
     *            field values. 3.whereColumnValue : An array of field values.
     *            4.joinCondition : The join condition.
     * @param onlyDistinctRows
     *            True if only distinct rows should be selected
     ...
     * @param tableName
     *            :table name.
     * @param columnValueBeanSet
     *            :set of column value beans.
     * @return (1) the row count for INSERT,UPDATE or DELETE statements or (2) 0
     ...
     *
     * @param tableName
     *            : table name must match the table name as it is stored in this
     *            database
     * @return a ResultSet object for this Connection object
    ...
    /**
     * Returns the ResultSet containing all the rows according to the columns
     * specified from the table represented in sourceObjectName.
     *
     * @param sourceObjectName
     *            The table name.
     * @param selectColumnName
     ...
     * @param onlyDistinctRows
     *            true if only distinct rows should be selected
     * @return The ResultSet containing all the rows according to the columns
     *         specified from the table represented in sourceObjectName.
     * @throws DAOException
     *             generic DAOException.
     */
    ...
    /**
     * This method has been added to close statement for which resultset is
     * returned.
     *
     * @param resultSet
     *            ResultSet
     ...
     *             : database exception
     */
    void batchInitialize(int batchSize, String tableName, SortedSet<String> columnSet) throws DAOException;

    /**
     * @param dataMap
     *            Map holding the column value data.
     * @throws DAOException
     *             : database exception.
     */
    ...
    /**
     * This method added only for CIDER, next releases handles this
     * issue(Quick/Patch fix).
     *
     * @deprecated
     */
    @Deprecated
